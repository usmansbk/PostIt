...
var _PostIt = __webpack_require__(50);
...
_reactDom2.default.render(_react2.default.createElement(_PostIt2.default, { greeting: 'Hello' }), document.getElementById('app'));
...
var PostIt = function (_React$Component) {
  _inherits(PostIt, _React$Component);
...
function postItApp() {
  ...
  switch (action.type) {
    ...
    case _actions.DELETE_GROUP:
    case _actions.ADD_GROUP:
      return Object.assign({}, state, {
...
var REMOVE_MEMBER = exports.REMOVE_MEMBER = 'REMOVE_MEMBER';
...
function deletePost(posts, error) {
  return {
    type: DELETE_POST,
    payload: {
      posts: posts
...
function addGroup(groups, error) {
  return {
    type: ADD_GROUP,
    payload: {
      posts: posts
...
function deleteGroup(groups, error) {
  return {
    type: DELETE_GROUP,
    payload: {
      posts: posts
...
function addMember(members, error) {
  return {
    type: ADD_MEMBER,
    payload: {
      members: members
...
function removeMember(members, error) {
  return {
    type: REMOVE_MEMBER,
    payload: {
      members: members
...
function addNotification(notifications, error) {
  return {
...
function clearNotification(notifications, error) {
  return {
